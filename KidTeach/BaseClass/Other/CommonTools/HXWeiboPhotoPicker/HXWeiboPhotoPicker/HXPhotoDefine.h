...
// 导航栏 + 状态栏 的高度
#define kNavigationBarHeight ((kDevice_Is_iPhoneX|| IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 88 : 64)
#define kTopMargin ((kDevice_Is_iPhoneX|| IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 44 : 0)
#define kBottomMargin ((kDevice_Is_iPhoneX|| IS_IPHONE_Xr ==YES || IS_IPHONE_Xs== YES || IS_IPHONE_Xs_Max== YES) ? 34 : 0)
