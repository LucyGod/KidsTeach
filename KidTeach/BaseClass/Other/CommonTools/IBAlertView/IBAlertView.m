...
- (void)setConfigration:(IBConfigration *)configration {
    ...
    _viewHeight = rect.size.height + 39 + 15 + 50 + 22+ 10;
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        _cancelButton.tag = 1;
        [_cancelButton setTitleColor:[UIColor colorWithHexString:@"#808287"] forState:UIControlStateNormal];
        _cancelButton.backgroundColor=[UIColor colorWithHexString:@"#E8E8E8"];
...
- (UIButton *)confirmButton {
    if (!_confirmButton) {
        ...
        [_confirmButton setTitleColor:ASOColorTheme forState:UIControlStateNormal];
        _confirmButton.backgroundColor = DefaultRedColor;
