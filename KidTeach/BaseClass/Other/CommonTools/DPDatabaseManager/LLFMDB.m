...
- (BOOL)lx_mine_db_createTable:(NSString *)tableName dicOrModel:(id)parameters
{
    return [self lx_mine_db_createTable:tableName dicOrModel:parameters excludeName:nil];
}
/**
 创建表
 ...
 @return 是否成功
 */
- (BOOL)lx_mine_db_createTable:(NSString *)tableName dicOrModel:(id)parameters excludeName:(NSArray *)nameArr
{
    NSDictionary *dic;
...
#pragma mark - *************** 增删改查
- (BOOL)lx_mine_db_insertTable:(NSString *)tableName dicOrModel:(id)parameters{
...
/**
 ...
 @return 是否删除成功
 */
- (BOOL)lx_mine_db_deleteTable:(NSString *)tableName whereFormat:(NSString *)format, ...
{
    va_list args;
...
/**
 ...
 @return 是否更新成功
 */
- (BOOL)lx_mine_db_updateTable:(NSString *)tableName dicOrModel:(id)parameters whereFormat:(NSString *)format, ...
{
    va_list args;
    va_start(args, format);
    NSString *where = format?[[NSString alloc] initWithFormat:format locale:[NSLocale currentLocale] arguments:args]:format;
 ...
 */
- (NSArray *)lx_mine_db_lookupTable:(NSString *)tableName dicOrModel:(id)parameters whereFormat:(NSString *)format, ...
{
    va_list args;
    va_start(args, format);
    NSString *where = format?[[NSString alloc] initWithFormat:format locale:[NSLocale currentLocale] arguments:args]:format;
...
//删除表
- (BOOL)lx_mine_db_deleteTable:(NSString *)tableName
{
...
//删除所有数据
- (BOOL)lx_mine_db_deleteAllDataFromTable:(NSString *)tableName
{
...
//表是否存在
- (BOOL)lx_mine_db_isExistTable:(NSString *)tableName
{
...
//返回表中字段名
- (NSArray *)lx_mine_db_columnNameArray:(NSString *)tableName
{
    return [self getColumnArr:tableName db:_db];
}

//表中多有少条数据
- (int)lx_mine_db_tableItemCount:(NSString *)tableName
{
...
- (BOOL)lx_mine_db_alterTable:(NSString *)tableName dicOrModel:(id)parameters
{
    return [self lx_mine_db_alterTable:tableName dicOrModel:parameters excludeName:nil];
}

- (BOOL)lx_mine_db_alterTable:(NSString *)tableName dicOrModel:(id)parameters excludeName:(NSArray *)nameArr
{
    __block BOOL flag;
    [self lx_mine_db_inTransaction:^(BOOL *rollback) {
        if ([parameters isKindOfClass:[NSDictionary class]]) {
...
- (void)lx_mine_db_inDatabase:(void(^)(void))block
{
...
- (void)lx_mine_db_inTransaction:(void(^)(BOOL *rollback))block
{
