...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info{
    ...
    if (self.isICON==YES) {
        ...
        self.imageCropperController=[[VPImageCropperViewController alloc] initWithImage:image cropFrame:CGRectMake((ScreenWidth-(ScreenWidth/1.2))/2,(ScreenHeight-(ScreenWidth/1.2))/2, ScreenWidth/1.2, ScreenWidth/1.2) limitScaleRatio:5];
        
        self.imageCropperController.isOriginal=YES;
    }else{
    
       self.imageCropperController.isOriginal=NO;
