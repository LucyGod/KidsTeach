...
- (void)drawRect:(CGRect)rect {
    ...
    [NSObject gl_drawTextBackGroundInRect:rect content:ctx boderColor:ASOColorGap boderWidth:1.0f fillColor:[ASOColorNormalText colorWithAlphaComponent:0.6]];
...
- (void)p_initialize {
    ...
    self.textColor = ASOColorBackGround;
