...
- (void)p_drawIndicatorDetailWithRect:(CGRect)rect {
    ...
    if (self.selectedModel) {
        ...
        NSAttributedString *VOLatt = [[NSAttributedString alloc] initWithString:volString attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10.0f],NSForegroundColorAttributeName:ASOColorBackGround}];
        ...
        NSMutableAttributedString *mattirbuteStr = [[NSMutableAttributedString alloc] initWithString:indicatorName attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10.0f],NSForegroundColorAttributeName:ASOColorTitle}];
