...
- (KLineView *)kLineMainView {
    if (!_kLineMainView) {
        ...
        _kLineMainView.backgroundColor = ASOColorText_000000;
        // 添加绘图算法
...
- (KLineView *)volView {
    if (!_volView) {
        ...
        _volView.backgroundColor = ASOColorText_000000;
        // 替换逻辑处理对象为主图逻辑处理对象
...
- (UIView *)verticalLineView {
    if (!_verticalLineView) {
        ...
        [_verticalLineView setBackgroundColor:ASOColorTitle];
...
- (UIView *)horizontalLineView {
    if (!_horizontalLineView) {
        ...
        [_horizontalLineView setBackgroundColor:ASOColorTitle];
...
//        _detailView.textColor = ASOColorTipText;
    }
    return _detailView;
}
